  ...
  return (
    <>
      <div className='background-container'>
        <h2 className='title-signup'>Be part of InmoLux</h2>
        <form onSubmit={handleSignup} className='form-signup'>
          ...
          <br />
          <label className="signup-label"><FaRegUserCircle className='icons-signup' /> Username:</label>
          <input className='signup-inputs' type="text" name="username" value={username} onChange={handleUsernameChange} />
          <br />
          <label className="signup-label"><MdOutlineAlternateEmail className='icons-signup' /> Email:</label>
          <input className='signup-inputs' type="email" name="email" value={email} onChange={handleEmailChange} />
          <br />
          <label className="signup-label"> <RiLockPasswordLine className='icons-signup' /> Password:</label>
